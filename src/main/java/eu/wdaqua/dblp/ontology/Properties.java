...
public class Properties {
    public static final ArrayList<Mapping> mappings = new ArrayList<Mapping>(Arrays.asList(
            ...
            new Mapping("journal","http://data.europa.eu/eli/ontology#published_in",Type.STRING),
            ...
            new Mapping("url","http://purl.org/dc/elements/1.1/identifier",Type.CUSTOM),
            ...
            new Mapping("series","http://lsdis.cs.uga.edu/projects/semdis/opus#in_series",Type.STRING),
