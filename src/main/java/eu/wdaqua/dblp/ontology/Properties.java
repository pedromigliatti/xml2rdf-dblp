...
public class Properties {
    public static final ArrayList<Mapping> mappings = new ArrayList<Mapping>(Arrays.asList(
            ...
            new Mapping("/www/author","https://schema.org/name",Type.CUSTOM),
            new Mapping("/www/author","http://www.w3.org/2000/01/rdf-schema#label",Type.LABEL),
...
//            new Mapping("/url","http://purl.org/dc/elements/1.1/identifier",Type.URI),
            ...
            new Mapping("/booktitle","http://www.w3.org/2000/01/rdf-schema#label",Type.LABEL),
            new Mapping("/journal","http://data.europa.eu/eli/ontology#published_in",Type.CUSTOM),
            new Mapping("/journal","http://www.w3.org/2000/01/rdf-schema#label",Type.LABEL),
            new Mapping("/series","http://lsdis.cs.uga.edu/projects/semdis/opus#in_series",Type.CUSTOM),
            new Mapping("/series","http://www.w3.org/2000/01/rdf-schema#label",Type.LABEL),
            new Mapping("/school","http://lsdis.cs.uga.edu/projects/semdis/opus#School",Type.STRING),
            new Mapping("/school","http://www.w3.org/2000/01/rdf-schema#label",Type.LABEL),
